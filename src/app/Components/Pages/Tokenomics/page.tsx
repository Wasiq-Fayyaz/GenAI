  ...
  return (
    <section className="flex flex-col items-center mt-24 w-full">
      ...
      >
        ...
        <div className="flex flex-col xl:flex-col items-center">
          <div className="flex flex-col lg:flex-row items-center">
            <div className="flex flex-col xl:flex-row justify-center gap-4 p-5">
              {/*Tax Distribution # 1* */}
              <div className="flex flex-col md:flex-row xl:flex-col items-center gap-4">
                <motion.div
            ...
            {/*-----------------------CHART DIV-----------------------* */}
            <div className="flex items-center transition ease-in-out duration-150 w-72 md:w-4/5 h-64 md:h-80 lg:h-96  cursor-pointer bg-neutral-900 rounded-xl hover:bg-neutral-800 ">
              <motion.div
